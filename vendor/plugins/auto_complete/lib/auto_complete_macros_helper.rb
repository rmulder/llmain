module AutoCompleteMacrosHelper      
  ...
  def auto_complete_result(entries, field, phrase = nil)
    ...
    # updated by jbennett to add ID clause
    items = entries.map { |entry| content_tag("li", phrase ? highlight(entry[field], phrase) : h(entry[field]), :id => entry.unique_id.to_s) }
    # also changed this to join and not escape
